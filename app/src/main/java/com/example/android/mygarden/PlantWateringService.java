...
public class PlantWateringService extends IntentService {
    ...
    public static final String EXTRA_PLANT_ID = "com.example.android.mkygarden.extra.PLANT_ID";
    ...
    private void handleActionWaterPlant(long plantId) {
        String stringPlantId = Long.toString(plantId);
        Log.e("CESSS: handleAWP", "plantId=" + String.valueOf(plantId));
        Uri SINGLE_PLANT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_PLANTS).appendPath(stringPlantId).build();
    ...
    private void handleActionUpdatePlantWidgets() {
        Log.e("CESSS:", "Entered handleActionUpdatePlantWidgets");
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            plantId = (long) cursor.getInt(cursor.getColumnIndex(PlantContract.PlantEntry._ID));
            Log.e("CESSS, Plantid=", String.valueOf(plantId));
            cursor.close();
            if (timeNow - wateredAt > PlantUtils.DANGER_AGE_WITHOUT_WATER) {showWaterButton = true;}
